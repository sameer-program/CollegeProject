      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b">
          <h2 className="text-xl font-semibold text-gray-900">
            Top Performing Knowledge Resources
          </h2>
        </div>
        <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <p className="text-gray-500">
            AI analysis shows consistent growth in knowledge base quality and
            user engagement. Most popular content categories: Technical
            Documentation, Best Practices, and Case Studies.
          </p>
        </div>
      </div>
    </div>
